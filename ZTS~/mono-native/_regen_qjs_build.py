...
src = Path(r"D:\workspace\zts\quickjs\quickjs.c")
dst = Path(r"D:\workspace\zts\ZTSTest\Packages\com.code-philosophy.zts\ZTS~\mono-native\qjs_inc\quickjs_build.c")
...
c = c.replace("#define CONFIG_ATOMICS", "/* CONFIG_ATOMICS disabled for MSVC ZTS build */")
c = c.replace("#define CONFIG_STACK_CHECK", "/* CONFIG_STACK_CHECK disabled for MSVC ZTS build */")
