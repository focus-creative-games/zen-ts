/**
 * ZTS ambient types (Docs/spec/05-LIB.md, 14-TYPESCRIPT.md).
 * Runtime still loads JS only; this file is editor/tsc only.
 */

declare const zts: ZTS.Lib;

declare const CSharp: ZTS.CSharpRoot;
...
declare namespace ZTS {
  ...
  /** SZ array instance (get/set/length). Not a JS Array; `T[]` is only `zts.to_array`. */
