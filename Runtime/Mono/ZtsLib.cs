...
namespace ZTS
{
    internal static class ZtsLib
    {
        ...
        private static string LoadZtsLibJs()
        {
            ...
            throw new TsScriptException("zts: ztslib.js not found.");
        }
        ...
        private static Type ResolveTypeArg(IntPtr ctx, JSValue value)
        {
            ...
            throw new TsScriptException("zts: generic type argument is not a Type.");
        }
        ...
        private static int[] ReadIntJsArray(IntPtr ctx, JSValue jsArray, string label)
        {
            ...
            {
                throw new TsScriptException($"zts: {label} must be a JS Array.");
            }
            ...
            for (int i = 0; i < raw.Length; i++)
            {
                ...
                {
                    throw new TsScriptException($"zts: {label}[{i}] is missing.");
                }
